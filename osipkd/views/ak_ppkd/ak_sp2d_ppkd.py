...
class view_ak_sp2d_ppkd(BaseViews):
    ...
    @view_config(route_name="ak-sp2d-ppkd", renderer="templates/ak-sp2d-ppkd/list.pt",
                 permission='read')
    def view_list(self):
    ...
    # Action #
    ##########    
    @view_config(route_name='ak-sp2d-ppkd-act', renderer='json',
                 permission='read')
    def view_act(self):
        ses = self.request.session
        req = self.request
    ...
    def route_list(self):
        return HTTPFound(location=self.request.route_url('ak-sp2d-ppkd'))
    ...
    @view_config(route_name='ak-sp2d-ppkd-posting', renderer='templates/ak-sp2d-ppkd/posting.pt',
                 permission='posting')
    ...
    @view_config(route_name='ak-sp2d-ppkd-unposting', renderer='templates/ak-sp2d-ppkd/unposting.pt',
