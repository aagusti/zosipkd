...
SESS_ADD_FAILED = 'Tambah ak-jurnal-ppkd gagal'
SESS_EDIT_FAILED = 'Edit ak-jurnal-ppkd gagal'
...
class view_ak_jurnal_ppkd(BaseViews):
    ########                    
    # List #
    ########    
    @view_config(route_name='ak-jurnal-ppkd', renderer='templates/ak-jurnal-ppkd/list.pt',
                 permission='read')
    def view_list(self):
    ...
    # Action #
    ##########    
    @view_config(route_name='ak-jurnal-ppkd-act', renderer='json',
                 permission='read')
    def ak_jurnal_ppkd_act(self):
        ses = self.request.session
        req = self.request
        params = req.params
        url_dict = req.matchdict
    ...
    def route_list(self):
        return HTTPFound(location=self.request.route_url('ak-jurnal-ppkd'))
        
    def session_failed(self, session_name):
        del self.session[session_name]
        
    @view_config(route_name='ak-jurnal-ppkd-add', renderer='templates/ak-jurnal-ppkd/add.pt',
                 permission='add')
    def view_ak_jurnal_ppkd_add(self):
        req = self.request
        ses = self.session
            ...
            if 'simpan' in req.POST:
                ...
                if not controls_dicted['kode']=='':
                    ...
                    if cek :
                        ...
                        return HTTPFound(location=self.request.route_url('ak-jurnal-ppkd-add'))
                ...
                return HTTPFound(location=req.route_url('ak-jurnal-ppkd-edit',id=row.id))
    ...
    @view_config(route_name='ak-jurnal-ppkd-edit', renderer='templates/ak-jurnal-ppkd/add.pt',
                 permission='edit')
    def view_ak_jurnal_ppkd_edit(self):
        ...
        if request.POST:
            if 'simpan' in request.POST:
                ...
                if cek:
                    ...
                    if d!=c:
                        self.request.session.flash('Kode Jurnal sudah ada', 'error')
                        return HTTPFound(location=request.route_url('ak-jurnal-ppkd-edit',id=row.id))
    ...
    # Delete #
    ##########    
    @view_config(route_name='ak-jurnal-ppkd-delete', renderer='templates/ak-jurnal-ppkd/delete.pt',
                 permission='delete')
    ...
    @view_config(route_name='ak-jurnal-ppkd-posting', renderer='templates/ak-jurnal-ppkd/posting.pt',
                 permission='posting')
    ...
    @view_config(route_name='ak-jurnal-ppkd-unposting', renderer='templates/ak-jurnal-ppkd/unposting.pt',
