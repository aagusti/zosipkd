...
class AddSchema(colander.Schema):
    ...
    jv_type     = colander.SchemaNode(
                    colander.String(),
                    widget=widget.SelectWidget(values=JV_TYPE,  readonly=True),
                    title="Tipe"
                    )
...
class view_ak_jurnal_item(BaseViews):
    ...
    def route_list(self):
        return HTTPFound(location=self.request.route_url('ak-jurnal-item') )
    ...
    @view_config(route_name='ak-jurnal-item-add', renderer='templates/ak-jurnal-item/add.pt',
                 permission='add')
    def view_ak_jurnal_item_add(self):
        req = self.request
        ses = self.session
        ...
        if req.POST:
            if 'simpan' in req.POST:
                ...
                try:
                    ...
                    #return HTTPFound(location=req.route_url('ak-jurnal-item-add'))
    ...
    @view_config(route_name='ak-jurnal-item-edit', renderer='templates/ak-jurnal-item/add.pt',
                 permission='edit')
    def view_ak_jurnal_item_edit(self):
        ...
        if request.POST:
            if 'simpan' in request.POST:
                ...
                try:
                    ...
                    #return HTTPFound(location=request.route_url('ak-jurnal-item-edit',
                    #                  id=row.id))
    ...
    # Delete #
    ##########    
    @view_config(route_name='ak-jurnal-item-delete', renderer='templates/ak-jurnal-item/delete.pt',
                 permission='delete')
    def view_ak_jurnal_item_delete(self):
        request = self.request
        q = self.query_id()
        row = q.first()
