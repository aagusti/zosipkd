...
class view_ar_sts_item(BaseViews):     
    ...
    # Action #
    ##########    
    @view_config(route_name='ar-sts-kas-item-act', renderer='json',
                 permission='read')
    def view_act(self):
...
# Add #
#######
@view_config(route_name='ar-sts-kas-item-add', renderer='json',
             permission='add')
...
@view_config(route_name='ar-sts-kas-item-edit', renderer='json',
             permission='edit')
...
# Delete #
##########    
@view_config(route_name='ar-sts-kas-item-delete', renderer='json',
             permission='delete')
