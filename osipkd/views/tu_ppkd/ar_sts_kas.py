...
class view_ar_sts(BaseViews):
    ...
    @view_config(route_name="ar-sts-kas", renderer="templates/ar-sts-kas/list.pt",
                 permission='read')
    def view_list(self):
    ...
    # Action #
    ##########    
    @view_config(route_name='ar-sts-kas-act', renderer='json',
                 permission='read')
    def view_act(self):
        ses = self.request.session
        req = self.request
...
def route_list(request):
    return HTTPFound(location=request.route_url('ar-sts-kas'))
...
@view_config(route_name='ar-sts-kas-add', renderer='templates/ar-sts-kas/add.pt',
             permission='add')
        ...
        if 'simpan' in request.POST:
            ...
            if not controls_dicted['kode']=='':
                ...
                if cek :
                    ...
                    return HTTPFound(location=request.route_url('ar-sts-kas-add'))
            ...
            return HTTPFound(location=request.route_url('ar-sts-kas-edit',id=row.id))
...
@view_config(route_name='ar-sts-kas-edit', renderer='templates/ar-sts-kas/add.pt',
             permission='edit')
...
# Validasi #
############
@view_config(route_name='ar-sts-kas-validasi', renderer='templates/ar-sts-kas/add2.pt',
             permission='validasi')
...
# Delete #
##########    
@view_config(route_name='ar-sts-kas-delete', renderer='templates/ar-sts-kas/delete.pt',
             permission='delete')
