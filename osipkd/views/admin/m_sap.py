...
class view_rekening(BaseViews):
            ...
            if 'simpan' in req.POST:
                ...
                if not controls_dicted['kode']=='':
                    ...
                    if cek :
                        ...
                        return HTTPFound(location=self.request.route_url('sap-add'))
    ...
    @view_config(route_name='sap-edit', renderer='templates/sap/add.pt',
                 permission='edit')
            ...
            if 'simpan' in request.POST:
                ...
                if cek:
                    ...
                    if d!=c:
                        ...
                        return HTTPFound(location=request.route_url('sap-edit',id=row.id))
