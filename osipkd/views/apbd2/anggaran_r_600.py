...
from osipkd.models.apbd_admin_models import (TahunModel, UserApbdModel,UnitModel,
     UrusanModel, RekeningModel, ProgramModel, KegiatanModel, DasarHukumModel)
...
class ViewAnggaranRAPBD(BaseViews):
    @view_config(route_name="anggaran_r600", renderer="osipkd:templates/apbd/anggaran/r600.pt")
    ...
    def anggaran_r600_act(self):
        ...
        if self.logged :
            if url_dict['act']=='r611' and self.is_akses_mod('read'):
            ...
            elif url_dict['act']=='r6111' and self.is_akses_mod('read'):
            ...
            elif url_dict['act']=='r612' and self.is_akses_mod('read'):

                query = DBSession.query(KegiatanSubModel.tahun_id, UrusanModel.kode.label('urusan_kd'),
                   UrusanModel.nama.label('urusan_nm'), UnitModel.kode.label('unit_kd'), UnitModel.nama.label('unit_nm'),
                   ...
                   .filter(KegiatanItemModel.kegiatan_sub_id==KegiatanSubModel.id,
                       ...
                       ProgramModel.urusan_id==UrusanModel.id, KegiatanSubModel.unit_id==UnitModel.id,
            ...
            elif url_dict['act']=='r613' and self.is_akses_mod('read'):
            ...
            elif url_dict['act']=='r614' and self.is_akses_mod('read'):
                ...
                query = DBSession.query(KegiatanSubModel.tahun_id, UrusanModel.kode.label('urusan_kd'),
                   ...
                   KegiatanItemModel.vol_2_1*KegiatanItemModel.vol_2_2*KegiatanItemModel.hsat_2)], else_=0)).label('pegawai1'),
                   func.sum(case([(func.substr(RekeningModel.kode,0,6)=='5.2.2',
                   KegiatanItemModel.vol_2_1*KegiatanItemModel.vol_2_2*KegiatanItemModel.hsat_2)], else_=0)).label('jasa1'),
                   func.sum(case([(func.substr(RekeningModel.kode,0,6)=='5.2.3',
                   KegiatanItemModel.vol_2_1*KegiatanItemModel.vol_2_2*KegiatanItemModel.hsat_2)], else_=0)).label('modal1'),
                   func.sum(case([(func.substr(RekeningModel.kode,0,6)=='5.2.1',
                   KegiatanItemModel.vol_4_1*KegiatanItemModel.vol_4_2*KegiatanItemModel.hsat_4)], else_=0)).label('pegawai2'),
                   func.sum(case([(func.substr(RekeningModel.kode,0,6)=='5.2.2',
                   KegiatanItemModel.vol_4_1*KegiatanItemModel.vol_4_2*KegiatanItemModel.hsat_4)], else_=0)).label('jasa2'),
                   func.sum(case([(func.substr(RekeningModel.kode,0,6)=='5.2.3',
                   KegiatanItemModel.vol_4_1*KegiatanItemModel.vol_4_2*KegiatanItemModel.hsat_4)], else_=0)).label('modal2'))\
                   .filter(KegiatanItemModel.rekening_id==RekeningModel.id, KegiatanItemModel.kegiatan_sub_id==KegiatanSubModel.id,
                    KegiatanSubModel.unit_id==UnitModel.id, UnitModel.urusan_id==UrusanModel.id, 
                    KegiatanSubModel.kegiatan_id==KegiatanModel.id,
                    KegiatanModel.program_id==ProgramModel.id,
                    KegiatanSubModel.tahun_id==self.session['tahun'],
                    KegiatanSubModel.kegiatan_id>6)\
                   .group_by(KegiatanSubModel.tahun_id, UrusanModel.kode, UrusanModel.nama, 
                   UnitModel.kode, UnitModel.nama, ProgramModel.kode, ProgramModel.nama, 
            ...
            elif url_dict['act']=='r615' and self.is_akses_mod('read'):
            ...
            elif url_dict['act']=='r621' and self.is_akses_mod('read'):
            ...
            elif url_dict['act']=='r6211' and self.is_akses_mod('read'):
            ...
            elif url_dict['act']=='r622' and self.is_akses_mod('read'):
